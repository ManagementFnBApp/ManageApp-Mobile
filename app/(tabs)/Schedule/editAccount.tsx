import { Role, ShiftTab, StaffAccount } from '@/apis/ScheduleAPI';
...
const EditAccountPage: React.FC = () => {
    ...
    // ── Read route params (all arrive as strings) ──
    const {
        id,
        fullName: paramFullName,
        email: paramEmail,
        role: paramRole,
        avatarColor: paramAvatarColor,
        initials: paramInitials,
        shifts: paramShifts,
        ...
        avatarColor: string;
        initials: string;
        shifts: string;        // JSON-serialised ShiftTab[]
    }>();

    // ── Derive typed account from params ──
    const account: StaffAccount = {
        id:          id ?? '',
        fullName:    paramFullName ?? '',
        email:       paramEmail ?? '',
        role:        (paramRole ?? 'STAFF') as Role,
        avatarColor: paramAvatarColor ?? '#e0e0e0',
        initials:    paramInitials || undefined,
        shifts:      JSON.parse(paramShifts ?? '[]') as ShiftTab[],
    };
    ...
    const handleSave = () => {
        ...
        // TODO: call update API with `updated`
        ...
        Alert.alert(
            ...
            [
                { text: 'Cancel', style: 'cancel' },
                {
                    ...
                    style: 'destructive',
                    onPress: () => {
                        // TODO: call delete API with account.id
